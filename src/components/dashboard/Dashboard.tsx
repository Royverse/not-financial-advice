            ...
            <header className="flex flex-col xl:flex-row items-start xl:items-center justify-between gap-4 shrink-0">
                <div className="flex flex-col gap-2">
                    <motion.h1
                        ...
                        className="text-3xl md:text-5xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400"
                    >
                ...
                <div className="flex flex-col md:flex-row items-center gap-4 w-full xl:w-auto">
                    ...
                    <div className="flex bg-slate-800/50 p-1.5 rounded-2xl border border-white/5 backdrop-blur-md w-full md:w-auto">
                        ...
                        <button
                            ...
                            className={`flex-1 md:flex-none px-6 py-2.5 rounded-xl text-sm font-bold transition flex items-center justify-center gap-2 ${view === "portfolio"
